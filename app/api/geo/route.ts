...
export async function GET(){const b=await requirePermission('growth');if(b)return b;const r=await query('SELECT * FROM geo_queries ORDER BY created_at DESC LIMIT 200');return NextResponse.json(r.rows)}
